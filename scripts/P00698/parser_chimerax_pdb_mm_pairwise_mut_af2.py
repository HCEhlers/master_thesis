...
for pdb in structures:
    # Define data path
    DATA_PATH = '/Users/holger/Desktop/master_thesis/data/results_af2/' + uniprot_id + '/' + uniprot_id + '_' + pdb + '.result' 
...
np.save( '/Users/holger/Desktop/master_thesis/data/arodz12/pw_dist_rmsd/M_pair_P00698_mut_af2', pw_matrix)   
