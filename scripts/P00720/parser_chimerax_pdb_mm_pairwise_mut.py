...
np.save( '/Users/holger/Desktop/master_thesis/data/arodz12/pw_dist_rmsd/M_pair_P00720_mut', pw_matrix)   
...
print(df)
df.to_csv('/Users/holger/Desktop/master_thesis/data/arodz12/pw_dist_rmsd/signi_rmsd_pairs_pdb.csv')
# Close session
#run(session, "close")
