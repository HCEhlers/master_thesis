...
np.save( '/Users/holger/Desktop/master_thesis/data/arodz12/pw_dist_rmsd/M_pair_P61626_mut_af2', pw_matrix)   
...
print(df)
df.to_csv('/Users/holger/Desktop/master_thesis/data/arodz12/pw_dist_rmsd/signi_rmsd_pairs_af2_P61626.csv')
