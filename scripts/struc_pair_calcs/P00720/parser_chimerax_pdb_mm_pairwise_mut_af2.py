...
np.save(DATA_PATH_ROOT + '/data/arodz12/pw_dist_rmsd/M_pair_P00720_mut_af2', pw_matrix)   
...
print(df)
df.to_csv(DATA_PATH_ROOT + '/data/arodz12/pw_dist_rmsd/signi_rmsd_paris.csv')
# Close session
#run(session, "close")
