...
np.save(DATA_PATH_ROOT + '/data/arodz12/pw_dist_rmsd/M_pair_mut', pw_matrix)   
...
print(df)
df.to_csv(DATA_PATH_ROOT + '/data/arodz12/pw_dist_rmsd/signi_rmsd_pairs_pdb_P61626.csv')
# Close session
#run(session, "close")
